...
class TestBase(LiveServerTestCase):
    ...
    def setUp(self):
        ...
        # self.student1 = Student(email="cs1234567@ucl.co.uk", student_ref="CS1234567", name="Ahmet Roth")
        # self.student1.set_password("cs1234567")
        ...
        #self.teacher1 = Teacher(email="ct0000123@ucl.co.uk", user_type="teacher", teacher_ref="uclcs0002", title="Dr",
        #                        name="Lewis Baird")
        #self.teacher1.set_password("ct0000123")
        self.teacher1 = Teacher(email=t1.get('email'), user_type=t1.get('role'), teacher_ref=t1.get('uni_id'), title=t1.get('title'), name=t1.get('name'))
...
class TestRegistration(TestBase):
    ...
    def test_registration(self):
        """
        Test that a user can create an account using the signup form
        ...
        assert "Signup succeeded" in success_message
